<?php
    ...
    $password=md5(md5(mysqli_real_escape_string($connect,$_POST['password'])));
    ...
    $duplicate_user_result=mysqli_query($connect,$duplicate_user_query) or die(mysqli_error($connect));
    ...
    if($rows_fetched>0){
        ...
        $user_registration_result=mysqli_query($connect,$user_registration_query) or die(mysqli_error($connect));
